...
if (PAYTM_ENVIRONMENT == 'PROD') {
	...
	$PAYTM_MERCHANT_MID 		= "vVrxQx29486600140083";
	$PAYTM_MERCHANT_KEY 		= "QzJWthQjgn4g#kNo";

	$PAYTM_CHANNEL_ID 	= "WEB";
	$PAYTM_INDUSTRY_TYPE_ID = "Retail";
	$PAYTM_MERCHANT_WEBSITE = "DEFAULT";
	$PAYTM_CALLBACK_URL 	= url('/payment/status');
	...
	//Change this constant's value with Merchant key received from Paytm.
	$PAYTM_MERCHANT_MID 		= "ahIZWw67747982538690";
	$PAYTM_MERCHANT_KEY 		= "QC_1gb_dwlIGt1WB";
